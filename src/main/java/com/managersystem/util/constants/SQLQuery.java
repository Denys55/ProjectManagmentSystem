...
public class SQLQuery {
    ...
    public static final String INSERT_CUSTOMER = "INSERT INTO INSERT CUSTOMERS (id, name, budget) values(default, ?, ?)";
    ...
    public static final String INSERT_PROJECT = "INSERT INTO INSERT PROJECTS (id, name, complexity, cost) values(default, ?, ?, ?)";
    ...
    public static final String SELECT_ALL_PROJECTS = "SELECT id, name, complexity, cost FROM CUSTOMERS";

    //sql query for skill
    public static final String INSERT_SKILL = "INSERT INTO INSERT SKILLS (id, languages, level) values(default, ?, ?)";
